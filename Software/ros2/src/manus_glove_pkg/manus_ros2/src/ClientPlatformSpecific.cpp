...
{
	(void)p_ConsoleScrollback; // Suppress unused parameter warning.
	...
	printf("\033[8;%d;%dt", p_ConsoleHeight, p_ConsoleWidth); // \e replaced with \033 to suppress build warnings.
